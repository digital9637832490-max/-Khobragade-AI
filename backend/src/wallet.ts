...
export async function changeCoins(
  ...
  if(!locked.rowCount) throw new Error('User not found');
  ...
  const ledger = await client.query(
    `INSERT INTO wallet_transactions(user_id,type,coins,balance_after,source,reason,reference_id,admin_id)
     VALUES($1,$2,$3,$4,$5,$6,$7,$8) RETURNING *`,
    [userId,type,coins,next,source,reason||null,referenceId||null,adminId||null]
  );
