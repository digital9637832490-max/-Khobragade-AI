...
const fallback=['total_users','active_users','ai_generations','video_jobs','failed_jobs'];
const icons=['♟','✓','⌛','₹','◆','◉','↗','✦','▶','!'];
