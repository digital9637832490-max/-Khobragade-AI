...
export default function CmsManager({scope}:{scope:Scope}){
 ...
 return <>
  <div className="top"><div><h1>{scope==='admin'?'Admin CMS':scope==='website'?'Website CMS':'App CMS'}</h1><p>A-to-Z control: content, design, behavior/actions, validation, visibility, order and lifecycle.</p></div><button className="button" onClick={fresh}>+ New Item</button></div>
