...
('website','home.features','section','Home Features',
 '{"items":["AI Thumbnail Maker","AI Title Generator","AI Description Generator","AI Tags + Hashtags","Photo → Video"]}',
...
('website','page.pricing','page','Pricing Page','{"heading":"Pricing","body":"All listed AI features are available directly without a wallet."}','{"visible":true}','{}','{}',120),
