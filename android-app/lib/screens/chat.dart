...
class _ChatScreenState extends State<ChatScreen>{
 final api=Api(),input=TextEditingController(),scroll=ScrollController(),speech=stt.SpeechToText(),tts=FlutterTts();List<Map<String,String>> messages=[];bool busy=false,listening=false,voiceMode=false,voiceRestarting=false;int coins=0;String voiceGender='female';Map<String,dynamic>? maintenance;DateTime? quotaUntil;String quotaKind='';Timer? clock;
